...
import {setProductInfo} from './store/actions/index';
const Product = lazy(()=>import('./component/Catalogo/ProductCard/Product/Product'));


function App({productInfo, opencart, setProductInfo}) {
...
useEffect(()=>{ 
   admin()
   if (localStorage.getItem('idProd')) setProductInfo(localStorage.getItem('idProd'))
}, []) 
...
export default connect(mapStateToProps,{setProductInfo})(App);
