...
export default function NavBarUser ({logOut, setFlag, flag}) {
    ...
    /* const  secondImg='https://image.flaticon.com/icons/png/512/64/64096.png'
    const img = image && `https://bomba-ecommerce.herokuapp.com${image.imgUrl}` || secondImg; */
    const  secondImg='https://media.discordapp.net/attachments/755566230412329011/780420765489037342/bomba.png'
   
    
    const imagen = (image) => {
        if(image.imgUrl[0]==='/'){ 
            return `https://bomba-ecommerce.herokuapp.com${image.imgUrl}`
        }
