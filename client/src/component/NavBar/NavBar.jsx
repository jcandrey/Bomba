...
function NavBar () {
    ...
    return (
        <div className= {s.contenedor}>
            <button className={sideBar ? s.none : s.sideBarButton} onClick={toggleSideBar}><MenuOutlinedIcon/></button>
            <button className={sideBar ? s.backButton : s.none} onClick={toggleSideBar}>
