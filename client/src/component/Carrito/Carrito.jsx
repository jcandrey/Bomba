        ...
        sidebar={
            data.length ?
                    ...
                    <div className={s.producto}>
                        <div className={s.org}> 
                            <div className={s.imgCont}>
                                <img className={s.img} src = { producto.product.images[0] ?`https://bomba-ecommerce.herokuapp.com${producto.product.images[0].imgUrl}` : null}/>
                            </div>
                        ...
                        <div className={s.or}>
                            <div className={s.editCant}>
                                <EditCantidad key={producto.product.id} setFlag = {setFlag} flag = {flag} quantity = {producto.line.quantity} stock = {producto.product.stock} productId = {producto.product.id} price = {producto.product.price}/>
                        ...
                        <div className={s.summary}>
                            ...
                            <div className={s.buttonCont}>
                                <button onClick={()=>guestToUser()}className={s.button}>Checkout</button>
                                <button onClick={()=>openCart(false)} className={s.button}>Volver</button>
                            </div>
                        </div>
                </div>: 
                <div className={s.vacio}>
                    ...
                    <Link to='/catalogo' onClick={()=> (openCart(false), setProductCatalogAll())} ><button  className={s.button}>Quiero comprar!</button></Link>
                </div> 
