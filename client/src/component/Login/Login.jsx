...
const newPassword2 = (password) => {
  ...
  const handleSubmit3 =(e)=>{
    e.preventDefault()
    window.location = 'https://bomba-ecommerce.herokuapp.com/auth/google'
  }

  const handleSubmit4 =(e)=>{
    e.preventDefault() 
    window.location = 'https://bomba-ecommerce.herokuapp.com/auth/facebook'
  }
              ...
              <form className={classes.form} noValidate>
                ...
                {errors.email || errors.password || errors.check ? 
                  ...
                  <div className={s.center}>
                    <Link href="https://bomba-ecommerce.herokuapp.com/users/create">
                      <div className={s.center}>
