            ...
            <table className = {`table ${s.table}`}>
                <thead className="table table-hover table-dark  ">
                    <tr>
                        ...
                        <th scope="row">
                            <select onClick={(name)=>searchByState(name)}className={`custom-select ${s.select}`}>
                                <option onClick={()=>getAll()}>Todos los Carritos</option>
                                <option name='created'>Creado</option>
                                <option name='processing'>Procesando</option>
                                <option name='canceled'>Cancelado</option>
                ...
                { display instanceof Array ? display.map(element => (
                    ...
                    <tr className={tableRowStyle(element.state)}>
                        ...
                        <th typeof='button' onClick={()=>searchById(element.userId)}>{element.userId ? element.user.first_name : null}</th>
